...
public class AutomationProject4_Camper {
  @Test
  public void f() throws InterruptedException, IOException {
	 // System.setProperty("Webdriver.chorme.driver","C:\\Users\\saeea\\OneDrive\\Desktop\\Seleniumprojetcs\\chromedriver-win64\\chromedriver-win64\\chromedriver.exe");
		...
		Thread.sleep(3000);
		FileInputStream fis = new FileInputStream("C:\\Test\\ReadData.xlsx");
		...
		for (int i = 1; i <= rows; i++) {
			...
			WebElement SendQuote=driver.findElement(By.xpath("/html/body/div[1]/div/div[1]/div/div/form"));
			SendQuote.click();
			...
			//break;
				/*String value= String.valueOf((int)row.getCell(0).getNumericCellValue());
				String cell0=String.valsueOf((int)row.getCell(0));
				engineperform.sendKeys(value);*/
			}
